...
if (isset($_POST['name'])) {
    ...
    $sql = "INSERT INTO `z_trip`.`trip` (`name`, `age`, `gender`, `email`, `phone`, `address`, `Other_Information`,`dt`) 
    VALUES ('$name', '$age', '$gender', '$email', '$phone', '$address', '$Other_Information',current_timestamp())";
